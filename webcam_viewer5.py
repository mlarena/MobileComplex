...
class WebcamApp:
    def __init__(self, window):
        ...
        ttk.Label(self.control_frame, text="Выберите камеру:").pack(side="left", padx=5)
        ...
        self.camera_combo = ttk.Combobox(self.control_frame, textvariable=self.camera_var, 
                                       values=self.cameras, state="readonly")
        ...
        # Единая кнопка для применения/прекращения
        self.network_button = ttk.Button(self.control_frame, text="Применить", command=self.toggle_network)
